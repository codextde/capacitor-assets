...
class Project extends project_1.MobileProject {
  ...
  async androidExists() {
    var _a, _b;
    return (
      ((_a = this.config.android) === null || _a === void 0 ? void 0 : _a.path) &&
      (await (0, utils_fs_1.pathExists)((_b = this.config.android) === null || _b === void 0 ? void 0 : _b.path))
    );
  }
  async iosExists() {
    var _a, _b;
    return (
      ((_a = this.config.ios) === null || _a === void 0 ? void 0 : _a.path) &&
      (await (0, utils_fs_1.pathExists)((_b = this.config.ios) === null || _b === void 0 ? void 0 : _b.path))
    );
  }
