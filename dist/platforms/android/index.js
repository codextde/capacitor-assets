      ...
      const generatedSplashes = await Promise.all(
        splashes.map(async (splash) => {
          ...
          return this._generateSplashesFromLogo(
            ...
            splash,
            pipe,
            (_a = this.options.splashBackgroundColor) !== null && _a !== void 0 ? _a : '#ffffff'
          );
        })
      );
    ...
    const generatedSplashes = await Promise.all(
      darkSplashes.map(async (splash) => {
        ...
        return this._generateSplashesFromLogo(
          ...
          splash,
          pipe,
          (_a = this.options.splashBackgroundColorDark) !== null && _a !== void 0 ? _a : '#111111'
        );
      })
    );
    generated.push(...generatedSplashes);
      ...
      create: {
        ...
        background:
          asset.kind === 'logo' /* Logo */
            ? (_a = this.options.iconBackgroundColor) !== null && _a !== void 0
              ? _a
              : '#ffffff'
            : (_b = this.options.iconBackgroundColorDark) !== null && _b !== void 0
            ? _b
            : '#111111',
      },
    });
  ...
  async _generateSplashesFromLogo(project, asset, splash, pipe, backgroundColor) {
    ...
    let targetWidth =
      (_b = this.options.logoSplashTargetWidth) !== null && _b !== void 0
        ? _b
        : Math.floor(((_c = splash.width) !== null && _c !== void 0 ? _c : 0) * targetLogoWidthPercent);
    ...
    if (targetWidth > splash.width || targetWidth > splash.height) {
      (0, log_1.warn)(
        `Logo dimensions exceed dimensions of splash ${splash.width}x${splash.height}, using default logo size`
      );
...
<adaptive-icon xmlns:android="http://schemas.android.com/apk/res/android">
  ...
  async updateManifest(project) {
    var _a, _b;
    (_b = (_a = project.android) === null || _a === void 0 ? void 0 : _a.getAndroidManifest()) === null || _b === void 0
      ? void 0
      : _b.setAttrs('manifest/application', {
  ...
  getResPath(project) {
    ...
    return (0, path_1.join)(
      project.config.android.path,
      'app',
      'src',
      (_a = this.options.androidFlavor) !== null && _a !== void 0 ? _a : 'main',
      'res'
    );
  }
}
