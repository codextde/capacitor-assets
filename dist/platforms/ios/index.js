...
exports.IosAssetGenerator =
  exports.IOS_SPLASH_IMAGE_SET_PATH =
  exports.IOS_SPLASH_IMAGE_SET_NAME =
  exports.IOS_APP_ICON_SET_PATH =
  exports.IOS_APP_ICON_SET_NAME =
    void 0;
...
class IosAssetGenerator extends asset_generator_1.AssetGenerator {
  ...
  async generateFromLogo(asset, project) {
    ...
    const targetWidth =
      (_b = this.options.logoSplashTargetWidth) !== null && _b !== void 0
        ? _b
        : Math.floor(((_c = asset.width) !== null && _c !== void 0 ? _c : 0) * targetLogoWidthPercent);
    if (asset.kind === 'logo' /* Logo */) {
      ...
      for (const lightSplash of lightSplashes) {
        ...
        const canvas = (0, sharp_1.default)({
          create: {
            ...
            channels: 4,
            background:
              (_f = this.options.splashBackgroundColor) !== null && _f !== void 0 ? _f : lightDefaultBackground,
          },
        });
    ...
    for (const darkSplash of darkSplashes) {
      ...
      const canvas = (0, sharp_1.default)({
        create: {
          ...
          channels: 4,
          background:
            (_j = this.options.splashBackgroundColorDark) !== null && _j !== void 0 ? _j : darkDefaultBackground,
        },
      });
      const resized = await (0, sharp_1.default)(asset.path).resize(targetWidth).toBuffer();
  ...
  async generateIconsForLogo(asset, project) {
    const icons = Object.values(IosAssetTemplates).filter((a) =>
      [
        ...
        'spotlight-icon' /* SpotlightIcon */,
      ].find((i) => i === a.kind)
    );
    return this._generateIcons(asset, project, icons);
  }
  async generateIcons(asset, project) {
    const icons = Object.values(IosAssetTemplates).filter((a) => a.kind === 'icon' /* Icon */);
    return this._generateIcons(asset, project, icons);
  }
  ...
  async generateSplashes(asset, project) {
    ...
    for (const assetMeta of assetMetas) {
      ...
      const g = new output_asset_1.OutputAsset(
        assetMeta,
        asset,
        project,
        {
  ...
  async updateSplashContentsJson(generated, project) {
    var _a;
    const contentsJsonPath = (0, path_1.join)(
    ...
    for (const g of generated) {
      const existing = withoutMissing.find(
        (f) => f.scale === `${g.template.scale}x` && f.idiom === 'universal' && typeof f.appearances === 'undefined'
      );
      if (existing) {
        existing.filename = g.template.name;
      } else {
