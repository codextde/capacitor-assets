...
class PwaAssetGenerator extends asset_generator_1.AssetGenerator {
  ...
  async getSplashSizes() {
    ...
    if (!this.options.pwaNoAppleFetch) {
      try {
        ...
        const sizes =
          (_a = target === null || target === void 0 ? void 0 : target.querySelectorAll('tr > td:nth-child(2)')) !==
            null && _a !== void 0
            ? _a
            : [];
  ...
  async _generateSplashFromLogo(project, asset, sizeString, pipe) {
    ...
    const targetWidth =
      (_c = this.options.logoSplashTargetWidth) !== null && _c !== void 0
        ? _c
        : Math.floor(width * targetLogoWidthPercent);
    if (asset.kind === 'logo' /* Logo */) {
      ...
      const lightSplashOutput = new output_asset_1.OutputAsset(
        template,
        asset,
        project,
        {
    ...
    const darkSplashOutput = new output_asset_1.OutputAsset(
      template,
      asset,
      project,
      {
  ...
  async generateIcons(asset, project) {
    ...
    const generatedAssets = await Promise.all(
      icons.map(async (icon) => {
        ...
        return new output_asset_1.OutputAsset(
          icon,
          asset,
          project,
          {
  ...
  async getPWADirectory(projectRoot) {
    if (
      await (0, utils_fs_1.pathExists)(
        (0, path_1.join)(projectRoot !== null && projectRoot !== void 0 ? projectRoot : '', 'public')
      ) /* React */
    ) {
      return (0, path_1.join)(projectRoot !== null && projectRoot !== void 0 ? projectRoot : '', 'public');
    } else if (
      await (0, utils_fs_1.pathExists)(
        (0, path_1.join)(projectRoot !== null && projectRoot !== void 0 ? projectRoot : '', 'src/assets')
      ) /* Angular and Vue */
    ) {
      return (0, path_1.join)(projectRoot !== null && projectRoot !== void 0 ? projectRoot : '', 'src/assets');
    } else if (
      await (0, utils_fs_1.pathExists)(
        (0, path_1.join)(projectRoot !== null && projectRoot !== void 0 ? projectRoot : '', 'www')
      )
    ) {
  ...
  async getPWAAssetsDirectory(pwaDir) {
    if (
      await (0, utils_fs_1.pathExists)((0, path_1.join)(pwaDir !== null && pwaDir !== void 0 ? pwaDir : '', 'assets'))
    ) {
  ...
  async updateManifest(project, assets) {
    ...
    const manifestPath = await this.getManifestJsonPath(
      (_b = project.directory) !== null && _b !== void 0 ? _b : undefined
    );
  ...
  async _generateSplash(project, asset, sizeString, pipe) {
    ...
    const name = `apple-splash-${width}-${height}@${density}${
      asset.kind === 'splash-dark' /* SplashDark */ ? '-dark' : ''
    }.png`;
    const pwaDir = await this.getPWADirectory((_a = project.directory) !== null && _a !== void 0 ? _a : undefined);
    const pwaAssetDir = await this.getPWAAssetsDirectory(pwaDir);
    const destDir = (0, path_1.join)(pwaAssetDir, exports.PWA_ASSET_PATH);
    ...
    const splashOutput = new output_asset_1.OutputAsset(
      template,
      asset,
      project,
      {
...
`);
    ...
    (0, log_1.log)(
      `<link rel="apple-touch-icon" href="${
        Object.values(
          (_a = mainIcon === null || mainIcon === void 0 ? void 0 : mainIcon.destFilenames) !== null && _a !== void 0
            ? _a
            : {}
        )[0]
      }">`
    ...
    for (const g of pwaAssets.filter((a) => a.template.kind === 'splash' /* Splash */)) {
      ...
      (0, log_1.log)(
        `<link rel="apple-touch-startup-image" href="${path}" media="(device-width: ${w}px) and (device-height: ${h}px) and (-webkit-device-pixel-ratio: ${
          template.density
    ...
    for (const g of pwaAssets.filter((a) => a.template.kind === 'splash' /* Splash */)) {
      ...
      (0, log_1.log)(
        `<link rel="apple-touch-startup-image" href="${path}" media="(device-width: ${h}px) and (device-height: ${w}px) and (-webkit-device-pixel-ratio: ${
          template.density
    ...
    for (const g of pwaAssets.filter((a) => a.template.kind === 'splash-dark' /* SplashDark */)) {
      ...
      (0, log_1.log)(
        `<link rel="apple-touch-startup-image" href="${path}" media="(prefers-color-scheme: dark) and (device-width: ${w}px) and (device-height: ${h}px) and (-webkit-device-pixel-ratio: ${
          template.density
        }) and (orientation: ${'portrait' /* Portrait */})>`
      );
    }
    for (const g of pwaAssets.filter((a) => a.template.kind === 'splash-dark' /* SplashDark */)) {
      ...
      (0, log_1.log)(
        `<link rel="apple-touch-startup-image" href="${path}" media="(prefers-color-scheme: dark) and (device-width: ${h}px) and (device-height: ${w}px) and (-webkit-device-pixel-ratio: ${
          template.density
        }) and (orientation: ${'landscape' /* Landscape */})>`
      );
    }
    console.log(
      ...
      pwaAssets.filter((a) => a.template.kind === 'splash-dark' /* SplashDark */).length
    );
    /*
